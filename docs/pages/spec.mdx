...
`Net(name_or_net=None, voltage=None, impedance=None, signal=None)` accepts a
...
**Signature:** `io(name, typ_or_template, checks=None, optional=False, help=None, direction=None, sink_current=None, source_current=None, signal=None)` or `io(typ_or_template, checks=None, optional=False, help=None, direction=None, sink_current=None, source_current=None, signal=None)`
